...
-- vim.api.nvim_set_keymap("n", "<leader>df", ":lua require('jdtls').test_class()<CR>")
-- vim.api.nvim_set_keymap(<leader>dn <Cmd>lua require'jdtls'.test_nearest_method()<CR>im.cmd [[setlocal tabstop=4]]) 
